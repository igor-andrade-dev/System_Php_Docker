            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="footer__about">
                    ...
                    <ul>
                        ...
                        <li>Telefone: <?php echo $telefone_loja ?></li>
            ...
            <div class="col-lg-12">
                <div class="footer__copyright">
                    <div class="footer__copyright__text"><p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                      Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos os Produtos são Demonstrativos | Loja Virtual Demo <i class="fa fa-heart" aria-hidden="true"></i> by <a class="text-info" href="" target="_blank">Igor César</a>
