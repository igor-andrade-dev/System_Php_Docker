...
<div class="col-lg-9 col-md-7">
    ...
    <div class="row">
        ...
        <?php
        if(@$_GET['txtBuscar'] != "") {
            $buscar = '%'.filter_var(@$_GET['txtBuscar'], @FILTER_SANITIZE_STRING).'%';
        ...
        $query = $pdo->prepare("SELECT * FROM produtos where (nome LIKE :buscar or palavras like :buscar) and ativo = 'Sim' order by id desc LIMIT $limite, $itens_por_pagina ");
        $query->bindValue(":buscar", $buscar);
        $query->execute();
        }else if($valor_inicial != ""){
            $query = $pdo->prepare("SELECT * FROM produtos where valor >= '$valor_inicial' and valor <= '$valor_final' and ativo = 'Sim' order by id desc");
        }
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">            
                <div class="product__discount__item">
                    ...
                    data-setbg="img/produtos/<?php echo $imagem ?>">
                      <img src="img/esgotado.png" width="65px" height="65px" style="position:absolute; right:0; top:0px; display:<?php echo $classe_esgotado ?>">
                    ...
                    <li style="display:<?php echo $classe_carrinho ?>"><a href="" onclick="carrinhoModal('<?php echo $id ?>','Não')"><i class="fa fa-shopping-cart"></i></a>
                     </ul>
                 </div>
     ...
     <div class="col-lg-4 col-md-6 col-sm-6">
       <div class="featured__item">       
        <div class="featured__item__pic set-bg" data-setbg="img/produtos/<?php echo $imagem ?>">
            <img class="" src="img/esgotado.png" width="65px" height="65px" style="position:absolute; right:0; top:0px; display:<?php echo $classe_esgotado ?>">
