      ...
      <div class="col-lg-9">
        ...
        <div class="hero__search__phone">
          <div class="hero__search__phone__icon">
            <a class="text-info" target="_blank" href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $whatsapp_link ?>" title="<?php echo $whatsapp_loja ?>"><i class="fa fa-whatsapp"></i></a>
          </div>
          <div class="hero__search__phone__text">
            <h6><?php echo $whatsapp_loja ?></h6>
...
<Lgpd-cookie text='Não capturamos nenhuma informação de dados sensíveis, somente cookies para melhor performance de nosso website!, os valores e qualquer informação aqui são ficticias, somente para preenchecimento de dados e demonstração do sistema!' />