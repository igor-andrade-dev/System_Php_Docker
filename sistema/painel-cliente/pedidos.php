...
$query_ped = $pdo->query("SELECT * FROM vendas where id_usuario = '$id_usuario' and pago != 'Sim' order by id desc ");
         ...
         for ($i=0; $i < @count($res_ped); $i++) { 
          ...
          $ref_pix = $res_ped[$i]['ref_pix'];         


          if($ref_pix != '' and $pago != 'Sim'){
            include('../../pagamentos/consultar_pagamento.php'); 
      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
         ...
         for ($i=0; $i < @count($res_ped); $i++) { 
          ...
          $id_venda = $res_ped[$i]['id'];
          $ref_pix = $res_ped[$i]['ref_pix'];
          $tipo_frete = $res_ped[$i]['tipo_frete'];
          ...
          <tr>
           ...
           <td>
            ...
            <?php if($pago != 'Sim'){  ?>
              <small><a target="_blank" class="text-danger" href="../../pagamentos/index.php?id_venda=<?php echo $id_venda ?>" title="Efetuar Pagamento">
          ...
          <td>
            ...
            <?php if($status == 'Enviado'){
               echo '<img src="../../img/envio.png" width"25px" height="25"><a class="text-primary" title="Código de Postagem"><small> '. $rastreio .' (<span class="text-danger">'.$tipo_frete.')</span></small></a>';
