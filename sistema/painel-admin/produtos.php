       ...
       <form method="post" id="form-item">
         <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label >Valor <small>Se tiver acréscimo<small></label>
              <input value="" type="text" class="form-control" id="acrescimo-item" name="acrescimo-item" placeholder="Valor de acréscimo R$">
            </div>

            <div class="form-group">
              <label ><small>Código Hexadecimal da Cor<small></label>
                <input value="" type="text" class="form-control" id="valor-item" name="valor-item" placeholder="Valor Item Ex #FFFFFF">
              </div>
            </div>
