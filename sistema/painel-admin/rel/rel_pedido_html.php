...
$tipo_frete = $res[0]['tipo_frete'];

 if($tipo_frete != ""){
    $tipo_frete = '<span class="text-danger"><small>('.$tipo_frete.')</small></span>';
    }else{
     $tipo_frete = '';
     }
...
<body>
	...
	<section class="area-cab">
		<div class="cabecalho">
			...
			<div class="coluna" style="width:25%"><small> <b>Frete : R$ </b><?php echo $frete.' '.$tipo_frete ?> </small></div>
	...
	<section class="area-cab">
		<div class="cabecalho">
			...
			<div class="coluna" style="width:32%"><small> <b>Email :  </b><?php echo $email_cli ?> </small></div>
	...
	<div class="mx-2" style="padding-top:40px ">
			...
			<section class="area-tab" style="background-color: #f5f5f5;">
				...
				<div class="linha-cab" style="padding-top: 5px;">
					...
					<div class="coluna" style="width:80%">PRODUTO</div>
					<div class="coluna" style="width:10%" align="center">VALOR</div>
			...
			<div class="cabecalho mb-1" style="border-bottom: solid 1px #e3e3e3;">
						...
						for ($i=0; $i < count($dados); $i++) { 
							...
							//$valor_prod = number_format($valor, 2, ',', '.');
							...
							$promocao = $dados2[0]['promocao'];							
										  ...
										  if($promocao == 'Sim'){
											    ...
											    $valor = $valor_promo;
											    //$valor_prod = number_format($valor_promo, 2, ',', '.');
											}
...
$total_itemF = number_format($total_item, 2, ',', '.');
							...
							<div class="coluna" style="width:80%">
								...
								if($combo != 'Sim'){
									...
									$query4 = $pdo->query("SELECT * FROM prod_combos where id_combo = '$id_produto' ");
									$res4 = $query4->fetchAll(PDO::FETCH_ASSOC);
							...
							<div class="coluna" style="width:10%" align="center">
								<?php echo $total_itemF ?>
							</div>
