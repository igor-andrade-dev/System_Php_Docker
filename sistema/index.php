<?php
    ...
    $res = $pdo->query("SELECT * FROM usuarios where nivel = 'Admin'"); 
    $dados = $res->fetchAll(PDO::FETCH_ASSOC);
    $senha = '123';
    $senha_crip = password_hash($senha, PASSWORD_DEFAULT);
    if(@count($dados) == 0){
      $res = $pdo->query("INSERT into usuarios (nome, cpf, email, senha, senha_crip, nivel, imagem) values ('Administrador', '000.000.000-00', '$email', '', '$senha_crip', 'Admin', 'sem-foto.jpg')");
    }
				...
				<div class="myform form ">
                   ...
                   <form action="autenticar.php" method="post" name="login">
                           <div class="form-group">
                              ...
                              <input type="text" name="email_login"  class="form-control" id="email_login" aria-describedby="emailHelp" placeholder="Insira seu Email ou CPF" value="">
                           </div>
                           <div class="form-group">
                              <label for="exampleInputEmail1">Senha</label>
                              <input type="password" name="senha_login" id="senha_login"  class="form-control" aria-describedby="emailHelp" placeholder="Senha" value="">
                           </div>
