        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                      <img src="img/esgotado.png" width="65px" height="65px" style="position:absolute; right:16px; top:0px; display:<?php echo $classe_esgotado ?>">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <div style="display:<?php echo $classe_carrinho ?>">
                        ...
                        <div class="row mt-4 mb-4 ml-1">
                            <?php 
                               ...
                               $query2 = $pdo->query("SELECT * from carac_prod where id_prod = '$id_produto' ");
                                ...
                                if($nome_carac == 'Cor' || $nome_carac == 'COR'){
                                    @$tem_cor = 'Sim';
                                }
                             ?>
                            <div class="mr-3 mt-2">
                                ...
                                for ($i2=0; $i2 < count($res4); $i2++) { 
                                    ...
                                    foreach ($res4[$i2] as $key => $value) {
                                       ...
                                       echo "<option value='".$res4[$i2]['id']."' >" . $res4[$i2]['nome'] .'  '. $valor_it . "</option>"; 
                            ...
                            <div class="checkout__input py-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div>
                                                                   <input class="form-control" type="text" name="cep2" id="cep" style="width:150px; display:inline-block;">
                ...
                <?php 
                        ...
                        if($estoque <= 0){   
                         echo 'Este produto no momento <b>não temos em estoque</b>, se tiver interesse em comprá-lo entre em contato conosco <a href="contatos.php" style="color:red">clicando aqui!</a>';                         
                        }                           
