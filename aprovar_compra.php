...
$pago = $dados[0]['pago'];
$total_da_venda = $dados[0]['total'];
$tipo_frete = $dados[0]['tipo_frete'];

$destinatario2 = $email_loja;
$destinatario = '';
...
$total_da_vendaF = number_format( $total_da_venda , 2, ',', '.');

$mensagem = '*'.$nome_loja.'* %0A';
$mensagem .= '✅ Sua Compra no valor de R$ '.$total_da_vendaF.' foi Aprovada! %0A%0A';

if($tipo_frete != ""){
    $mensagem .= '_Assim que enviarmos o seu pedido você receberá uma mensagem sobre o envio!_';
}
