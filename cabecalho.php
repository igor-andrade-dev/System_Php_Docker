...
//DETERMINAR O MENU SELECIONADO
if(@$_SESSION['menu'] == ''){
  $_SESSION['menu'] = 'inicio';
  $classe_inicio = 'active';
  $classe_cat = '';
  $classe_prod = '';
  $classe_blog = '';
  $classe_cont = '';
}else if(@$_SESSION['menu'] == 'inicio'){
  $classe_inicio = 'active';
  $classe_cat = '';
  $classe_prod = '';
  $classe_blog = '';
  $classe_cont = '';
}else if(@$_SESSION['menu'] == 'cat'){
  $classe_inicio = '';
  $classe_cat = 'active';
  $classe_prod = '';
  $classe_blog = '';
  $classe_cont = '';
}else if(@$_SESSION['menu'] == 'prod'){
  $classe_inicio = '';
  $classe_cat = '';
  $classe_prod = 'active';
  $classe_blog = '';
  $classe_cont = '';
}else if(@$_SESSION['menu'] == 'blog'){
  $classe_inicio = '';
  $classe_cat = '';
  $classe_prod = '';
  $classe_blog = 'active';
  $classe_cont = '';
}else if(@$_SESSION['menu'] == 'cont'){
  $classe_inicio = '';
  $classe_cat = '';
  $classe_prod = '';
  $classe_blog = '';
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            ...
            <li><a href="carrinho.php"><i class="fa fa-shopping-bag"></i> <span id="total_itens_cabecalho_menu"><?php echo $linhas ?></span></a></li>
            </ul>
            <div class="header__cart__price">item: <span id="total_valor_cabecalho_menu">R$ <?php echo $total_c ?></span></div>
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                 <li class="<?php echo $classe_inicio ?>"><a href="./index.php">Início</a></li>
                      <li class="<?php echo $classe_cat ?>"><a href="categorias.php">Categorias</a></li>
                     <li class="<?php echo $classe_prod ?>"><a href="#">Produtos</a>
                    ...
                    <li class="<?php echo $classe_blog ?>"><a href="blog.php">Blog</a></li>
                    
                    <li class="<?php echo $classe_cont ?>"><a href="contatos.php">Contatos</a></li>
            </ul>
        </nav>
        ...
        <div class="header__top__right__social">
            ...
            <a target="_blank" href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $whatsapp_link ?>" title="<?php echo $whatsapp_loja ?>"><i class="fa fa-whatsapp"></i></a>
        </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            <div class="header__top__right__social">
                               ...
                               <a target="_blank" href="#"><i class="fa fa-instagram"></i></a>
                               <a target="_blank" href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $whatsapp_link ?>" title="<?php echo $whatsapp_loja ?>"><i class="fa fa-whatsapp text-success"></i></a>
                           </div>
    ...
    <div class="container">
        ...
        <div class="col-lg-3">
            <div class="header__cart">
                <ul>
                   <li><a href="carrinho.php"><i class="fa fa-shopping-bag"></i> <span id="total_itens_cabecalho"><?php echo $linhas ?></span></a></li>
                </ul>
                <div class="header__cart__price">item: <span id="total_valor_cabecalho">R$ <?php echo $total_c ?></span></div>
            </div>
        </div>
    </div>
