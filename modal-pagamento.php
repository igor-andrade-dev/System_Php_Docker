            ...
            <div class="modal-body">
               ...
               <div class="row" align="center">
                     ...
                     <?php if($api_pix == "Sim"){ ?>
                      ...
                      <div class="mt-4" style="border-top: 1px solid #807e7e">
...
if (@$_GET["id_venda"] != null) {
 ...
 <script type="text/javascript">
  ...
  var valor = "<?=$vlr_venda_sem_format?>";
